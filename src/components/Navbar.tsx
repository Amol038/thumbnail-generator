        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    <NavLink to='/' className="hover:text-pink-300 transation">Home</NavLink>
                    <NavLink to='/generate' className="hover:text-pink-300 transation">Generate</NavLink>
                    <NavLink to='/my-generation' className="">MyGeneration</NavLink>
                    <NavLink to='#' className="hover:text-pink-300 transation">Contact</NavLink>
                </div>
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <NavLink onClick={() => setIsOpen(false)}to='/generate' >Generate</NavLink>
                <NavLink onClick={() => setIsOpen(false)} to='/my-generation' >MyGeneration</NavLink>
                <NavLink onClick={() => setIsOpen(false)} to='#' >Contact</NavLink>
