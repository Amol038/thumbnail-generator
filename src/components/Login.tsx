  ...
  return (
    ...
    <div className='min-h-screen flex items-center justify-center'>
        <form
                ...
                <div className="flex items-center w-full mt-4 bg-white/5 ring-2 ring-white/10 focus-within:ring-Pi-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
