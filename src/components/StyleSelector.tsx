...
import { ChevronDown, ChevronDownIcon, CpuIcon, ImageIcon, PenToolIcon, SparkleIcon, Square, SquareIcon } from "lucide-react";
    ...
    <div className="relative space-y-3 dark">
        ...
        hover:bg-white/12">
            <div className="space-y-1">
                <div className="flex items-centre gap-2 font-medium">
                    {styleIcons[value]}
                    <span>{value}</span>
                </div>
